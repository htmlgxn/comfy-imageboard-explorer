...
class TTLCache:
    ...
    def set(self, key: str, data: Any, ttl_seconds: float, last_modified: Optional[str]) -> None:
...
class ChanAPIClient:
    def __init__(self, base_url: str = "https://a.4cdn.org", timeout: float = 10.0) -> None:
