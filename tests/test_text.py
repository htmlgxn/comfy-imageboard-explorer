...
def test_strip_header_quotes():
    text = ">>1111\n>>2222\nHello >>3333"
    assert strip_header_quotes(text) == "Hello >>3333"


def test_extract_all_quotes():
